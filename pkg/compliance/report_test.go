...
func TestGenerateMarkdown_PassStatus(t *testing.T) {
	...
	// NSA CNSA 2.0 phased schedule (May 2025): begin 2025-2027 by category;
	// software/firmware signing + traditional networking complete by 2030;
	// web/cloud + OS + niche/custom complete by 2033.
	assertContains(t, out, "2025-01-01")
	assertContains(t, out, "2030-12-31")
	assertContains(t, out, "2033-12-31")
	// Footer
